...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
    ...
    print (fp.shape, len(sample_label), len(sample_length))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../data/NTU/nturgb+d_skeletons')
    parser.add_argument('--ignored_sample_path',
                        default='../data/NTU/samples_with_missing_skeletons.txt')
