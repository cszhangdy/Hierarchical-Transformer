...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/data/chengyibin/motion_3d/datasets/PKUMMD/Split/'
    if benchmark=='xview':
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/data/chengyibin/motion_3d/datasets/PKUMMD/data/pku_skeleton_ntu')
    parser.add_argument(
        '--ignored_sample_path',
        default='resource/PKUMMD/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='/data/chengyibin/motion_3d/datasets/PKUMMD/data/pku_dgnn')
