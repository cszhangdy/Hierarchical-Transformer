...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/data/chengyibin/motion_3d/datasets/PKUMMD/part-II/Split/'
    if benchmark=='xview':
    ...
    for filename in os.listdir(data_path):
        ...
        split_train_test_name = 'A{0:02d}N{1:02d}-{2:s}'.format(int(file_id / 13 + 1), int(file_id % 13 + 1), view_dic[view_id])
        # print (split_train_test_name, (split_train_test_name in training_set))
        # input()
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/data/chengyibin/motion_3d/datasets/PKUMMD/part-II/data/pku_skeleton_ntu')
    parser.add_argument(
        '--ignored_sample_path',
        default='/data/chengyibin/motion_3d/TSMF/resource/PKUMMD/samples_with_missing_skeletons_v2.txt')
    parser.add_argument('--out_folder', default='/data/chengyibin/motion_3d/datasets/PKUMMD/part-II/data/pku_dgnn')
    ...
    for b in benchmark:
        for p in part:
            ...
            if os.path.exists('{}/{}_data.npy'.format(out_path, part)):
                print ('{}/{}_data.npy exists!'.format(out_path, part))
                continue
            gendata(
                arg.data_path,
                out_path,
