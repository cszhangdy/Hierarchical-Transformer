...
skeleton_folder = '/data/chengyibin/motion_3d/datasets/PKUMMD/part-II/data/PKU_Skeleton_Renew/'
label_folder = '/data/chengyibin/motion_3d/datasets/PKUMMD/part-II/Label/Train_Label_PKU_final/'
save_path = '/data/chengyibin/motion_3d/datasets/PKUMMD/part-II/data/skeleton_ntu/'
# skeleton_folder = '/data/chengyibin/motion_3d/datasets/PKUMMD/data/PKU_Skeleton_Renew/'
# label_folder = '/data/chengyibin/motion_3d/datasets/PKUMMD/Label/Train_Label_PKU_final/'
# save_path = '/data/chengyibin/motion_3d/datasets/PKUMMD/data/skeleton_ntu/'
