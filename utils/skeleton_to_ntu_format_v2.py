...
Modified on Thu June 24 22:09 2021
For Part-II data
@by: Yi-Bin Cheng
"""
...
def transfer_and_save(file_id, file_view):
    ...
    sample_file = 'A{0:02d}N{1:02d}-{2:s}.txt'.format(int(file_id / 13 + 1), int(file_id % 13 + 1), file_view)
    # print (file_id, sample_file)
    # input()
...
for file_id in range(0, 338): # 338 == 26x13
